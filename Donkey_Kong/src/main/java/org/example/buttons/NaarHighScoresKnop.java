 ...
 */
public class NaarHighScoresKnop extends Knop {

    private DonkeyKong donkeyKong;

    public NaarHighScoresKnop(Coordinate2D initialLocation, DonkeyKong donkeyKong) {
        super(initialLocation, donkeyKong, "HighScores");
