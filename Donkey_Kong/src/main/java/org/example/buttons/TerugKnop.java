 ...
 */
public class TerugKnop extends Knop {

    private DonkeyKong donkeyKong;

    public TerugKnop(Coordinate2D initialLocation, DonkeyKong donkeyKong) {
        super(initialLocation, donkeyKong, "Back");
